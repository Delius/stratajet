class Reader < ActiveRecord::Base
  ...
  def sline3
    ...
    if s[2][2] == 'MON'&& s[2][4] == ' TUE' && s[2][8] == 'WED-THU' && s[2][11] == ' FRI' && s[2][13] == "SAT\r\n" && s[2][18] == 'SUN'
  ...
  def sline4
    ...
    if s[3][2] == 'MON'&& s[3][4] == ' TUE' && s[3][8] == 'WED-THU' && s[3][11] == ' FRI' && s[3][13] == "SAT\r\n" && s[3][18] == 'SUN'
  ...
  def sline5
    ...
    if s[4][2] == 'MON'&& s[4][4] == ' TUE' && s[4][8] == 'WED-THU' && s[4][11] == ' FRI' && s[4][13] == "SAT\r\n" && s[4][18] == 'SUN'
  ...
  def sline6
    ...
    if  s[5][2] == 'MON-WED' && s[5][4] == ' THU' && s[5][8] == 'FRI' && s[5][13] == 'SAT' && s[5][18] == 'SUN'
  ...
  def sline7
    ...
    if  s[6][2] == 'MON'&& s[6][4] == ' TUE-WED' && s[6][8] == 'THU' && s[6][11] == ' FRI' && s[6][13] == "SAT" && s[6][18] == 'SUN'
  ...
  def sline8
    ...
    if  s[7][2] == 'MON-TUE' && s[7][4] == ' WED-THU' && s[7][8] == 'FRI' && s[7][13] == 'SAT' && s[7][18] == 'SUN'
